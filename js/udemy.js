...
download.addEventListener("click", () => {
  // Lấy phần tử DOM chứa chứng chỉ để xuất file
  ...
  var opt = {
    ...
    // Thêm useCORS: true để cho phép render hình ảnh mà không bị lỗi Tainted Canvas
    html2canvas: { scale: 2, useCORS: true }, 
    // Đổi định dạng format từ 'c2' sang 'a4' cho an toàn và phổ biến hơn
